...
contains:[e.UNDERSCORE_TITLE_MODE]},{begin:"=>"},l,s]}}}());hljs.registerLanguage("vbscript",function(){"use strict";return function(e){
...
}),e.COMMENT(/'/,/$/,{relevance:0}),e.C_NUMBER_MODE]}}}());hljs.registerLanguage("css",function(){"use strict";return function(e){var n={
